...
<div class="max-w-4xl">
    ...
    <form action="/invoices" method="POST" class="space-y-6" id="invoiceForm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="date" id="due_date" name="due_date" required
                           value="<?= date('Y-m-d', strtotime('+' . ($settings['payment_terms'] ?? 30) . ' days')) ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-end gap-3">
            <a href="/invoices" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                Annuler
            </a>
...
function calculateTotals() {
    ...
    rows.forEach(row => {
        ...
        const lineTotal = Math.round(qty * price * 100) / 100; // Arrondi à 2 décimales
        subtotal += lineTotal;
        vatAmount += Math.round(lineTotal * (vat / 100) * 100) / 100; // Arrondi TVA ligne par ligne
