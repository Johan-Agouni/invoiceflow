...
<div class="max-w-4xl">
    <div class="mb-8">
        <a href="/invoices/<?= $invoice['id'] ?>" class="text-gray-500 hover:text-gray-700 text-sm flex items-center gap-1 mb-2">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
            Retour à la facture
        </a>
        <h1 class="text-3xl font-bold text-gray-900">Modifier la facture <?= htmlspecialchars($invoice['number']) ?></h1>
    </div>

    <form action="/invoices/<?= $invoice['id'] ?>" method="POST" class="space-y-6" id="invoiceForm">
            ...
            <div class="mt-6 pt-6 border-t flex justify-end">
                <div class="w-64 space-y-2">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium" id="vatAmount"><?= number_format($invoice['vat_amount'], 2, ',', ' ') ?> €</span>
                    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <textarea name="notes" rows="3" placeholder="Notes ou conditions particulières..."
                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?= htmlspecialchars($invoice['notes'] ?? '') ?></textarea>
        </div>
        ...
        <div class="flex justify-between">
            ...
            <div class="flex gap-3">
                <a href="/invoices/<?= $invoice['id'] ?>" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                    Annuler
                </a>
