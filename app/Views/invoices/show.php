...
<div class="mb-8">
    ...
    <div class="flex justify-between items-start">
        ...
        <div class="flex gap-3">
            <a href="/invoices/<?= $invoice['id'] ?>/pdf" download="facture_<?= htmlspecialchars($invoice['number']) ?>.pdf" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition flex items-center gap-2">
